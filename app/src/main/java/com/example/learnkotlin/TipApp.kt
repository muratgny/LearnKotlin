 ...
 */
@VisibleForTesting//To write a test for this function
internal fun calculateTip(amount: Double, tipPercent: Double = 15.0, roundUp: Boolean): String {//we made it internal because we
                                                                                                // will test it from outside
