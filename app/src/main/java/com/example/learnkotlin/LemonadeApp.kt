...
fun LemonadeDoApp() {
    ...
    It holds together different parts of the UI, such as app bars and floating action buttons, giving apps a coherent look
    and feel.
    * */
    Scaffold(
        topBar = {//part of a scaffold
        ...
        floatingActionButton = {//part of a scaffold
            FloatingActionButton(onClick = { currentStep++ }) {
                Icon(Icons.Default.Add, contentDescription = "Add")
            }
        }

    ) { innerPadding ->//part of a scaffold
        Surface(
            modifier = Modifier
                .fillMaxSize()
